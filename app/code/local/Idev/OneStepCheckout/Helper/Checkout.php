...
class Idev_OneStepCheckout_Helper_Checkout extends Mage_Core_Helper_Abstract
{
    ...
    public function loadConfig()
    {
        ...
        $items = array(
			...
			'exclude_fields/exclude_company', 'exclude_fields/exclude_fax', 'exclude_fields/exclude_region', 'exclude_fields/exclude_zip', 'exclude_fields/enable_comments', 'exclude_fields/enable_discount',
			'general/geoip_database', 'exclude_fields/enable_newsletter', 'terms/enable_terms',
			'general/checkout_title', 'general/checkout_description',
