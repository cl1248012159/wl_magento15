    ...
    public function getUrl(Mage_Catalog_Model_Product $product, $params = array())
    {
        ...
        if (is_null($url)) {
           ...
           /*if ($product->hasData('request_path') && $product->getRequestPath() != '') {
                ...
                $this->setData($cacheUrlKey, $product->getRequestPath());
            ...
            if ($product->getCategoryIds() && !$product->getDoNotUseCategoryIds() && Mage::getStoreConfig('catalog/seo/product_use_categories')) {
			    $_categories1 = $product->getCategoryIds();
               // $idPath .= '/'.$_categories1[0];
$idPath .= '/'.max($_categories1);
            }  // modify on 6.4
